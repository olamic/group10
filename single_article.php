...
// Get Article Info
$stmt = $conn->prepare("SELECT * FROM `article` INNER JOIN `users` ON `article`.author_id = `users`.id  WHERE `article_id` = ?");
...
$stmt = $conn->prepare("SELECT article_title, article_id FROM `article` WHERE author_id = ? LIMIT 4");
                    ...
                    <div class="post__content w-75 mx-auto">
                        ...
                        <div class="post-footer d-flex my-5">
                            ...
                            <div class="d-flex flex-column justify-content-around">
                                <h3 class="font-italic mb-1"><?= $article['fname'].''.$article['lname'] ?></h3>
                                <div class="social_media">
                                    <a href="" class="mr-3"><i class="fa fa-twitter"></i><span class="px-1"><?= $article['twitter'] ?></span></a>
                                    <a href="" class="mr-3"><i class="fa fa-linkedin-square"></i><span class="px-1"><?= $article['linked_in'] ?></span></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="aside col-3">
                    ...
                    <div class="p-3 bg-white border  border-muted">
                        <div class="d-flex align-items-center">
                            <img class="profile-thumbnail rounded-circle" src="img/avatar/avatar-1.png" alt="test avatar image" style="width: 60px;height: 60px;">
                            <h5 class="font-italic m-0"><?= $article['fname'].''.$article['lname'] ?></h5>
                        </div>

                        <div class="d-flex flex-column justify-content-between">
                            <div class="author_links">
                                <a href="https://twitter.com/<?= $article['twitter'] ?>" class="mr-3"><i class="fa fa-lg fa-twitter"></i></a>
                                <a href="https://linkedin.com/<?= $article['linked_in'] ?>" class="mr-3"><i class="fa fa-lg fa-linkedin-square"></i></a>
                            </div>
                        </div>
                    </div><!-- /Author Info -->

                    <div class="card bg-light my-3">
                        <div class="card-header"><strong> More from <?= $article['fname'].' '.$article['lname']  ?></strong></div>
